...
{
    public partial class CustomerEnquiryDetail : Form
    {
        int UniqueShopID = 0;
        string SelectedCustomerID = null;
        DataSet dsCustDetail = new DataSet();
        public CustomerEnquiryDetail(int ShopID)
        {
            InitializeComponent();
            UniqueShopID = ShopID;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            CustomerEnquiryReport pur = new CustomerEnquiryReport();
            DataTable dt = p.ShowEnquiryDetail(UniqueShopID, SelectedCustomerID, FdtVal, TdtVal).Tables[0];
